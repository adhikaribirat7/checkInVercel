...
import { updateCartQuantity } from "../../slices/featureProduct";
...
const AddToCartproduct = () => {
  ...
  return (
    <div className=" w-full flex justify-center items-center lg:flex-row gap-3 flex-col ">
      ...
      {isFull && (
        <div className="border-4 rounded-xl justify-start items-center flex flex-col gap-4 border-bg-grey h-auto self-start lg:w-[40%] w-full p-3">
          ...
          <div className="flex flex-col w-full gap-2">
            ...
            <span className="text-xl text-bg-gray">
              Total Number of Products:{list.reduce((accumulator, currentValue) => {
