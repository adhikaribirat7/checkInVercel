  ...
  return (
    <div className="basis-1/5 border-1 border-bg-gray rounded-xl">
      <div className="flex flex-col justify-center items-center sm:p-2 ">
        ...
        {/* <Link
          to="/single_products"
          className="w-full flex-col items-center m-4 justify-center "
        >
          <button
            type="submit"
            onClick={() => handleChnage(id)}
            // onClick={() =>setsingleProduct(products.id)}
            className="text-black border-2 outline-none border-white bg-bg-grey  flex justify-center items-center font-semibold rounded-3xl sm:p-3 text-xl h-10  w-full"
          >
            See More
          </button>
        </Link> */}
